...
export const intlConfig = {
  ...
  messages: {
    ...
    'tenant.category.mercado': 'Mercado',
    'tenant.category.marmitas': 'Marmitas',
    'tenant.category.cafe': 'Café',
    'tenant.category.doceria': 'Doceria',
    'tenant.category.foodTruck': 'Food Truck',
    'tenant.category.bar': 'Bar',
    'tenant.category.petiscaria': 'Petiscaria',
    'tenant.category.pastelaria': 'Pastelaria',
    'tenant.category.lanchonete': 'Lanchonete',
    'tenant.category.sorveteria': 'Sorveteria',
    ...
    'address.additionalInfo': 'Ponto de Referência',
    'address.additionalInfo.placeholder': 'ex: Casa com muro verde',
    'address.district': 'Bairro',
    'address.city': 'Cidade',
    'address.state': 'Estado',
    'address.streetRule': 'Preencha com o nome de sua rua',
    'address.numberRule': 'Obrigatório',
    'address.additionalInfoRule': 'Preencha um ponto de referência',
    ...
    'orders.setLast': 'Último',
    'orders.fulfilled': 'Entregue',
    'orders.recreate': 'Recriar',
    'orders.recreatePrompt': 'Tem certeza que deseja recriar esse pedido?',
    ...
    'orders.fulfillPrompt': 'Tem certeza que este pedido está entregue?',
    'orders.lastPrompt': 'Este pedido é o último da mesa?',
    'orders.state.confirmed': 'Confirmado',
    ...
    'order.stateChange.created': 'Criado',
    'order.stateChange.fulfilled': 'Finalizado',
    'order.stateChange.confirmed': 'Confirmado',
    'order.stateChange.canceled': 'Cancelado',
    'order.stateChange.recreated': 'Recriado',
    'order.statuses': 'Movimentação do Pedido',
    'common.yes': 'Sim',
    'common.no': 'Não',
  },
}
